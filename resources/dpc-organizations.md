# DPC Organizations and Professional Resources
...
Most state medical associations have resources for:
...
Some states have dedicated DPC groups:
- State-specific networking
...
- CME
- Practice management
- Some DPC-specific content
- Broad family medicine community
...
- How long have you been practicing DPC?
- What model do you use (pricing, structure)?
- What were your biggest challenges?
- Would you be open to occasional questions?

---

### Visiting Established Practices

Many DPC physicians welcome visits from aspiring DPC doctors:
- Shadow for a day
- See different practice models
...
- Offer to reciprocate when you're established
...
### When Starting
- [ ] Attend DPC Summit or regional event
- [ ] Connect with local DPC physicians
- [ ] Find a mentor
- [ ] Join state medical association

### Ongoing
- [ ] Stay active in communities
- [ ] Attend annual conference
- [ ] Mentor others as you gain experience
