...
- Determined your [Pricing](pricing-your-practice.md)
...
**Include:**
- Practice legal name and address
- Patient name (and responsible party for minors)
- Effective date
...
- This does not replace the need for health insurance
...
**Office Visits**
- Number of visits (unlimited vs. limit)
- Visit duration expectations
- Types of visits covered
...
- Point-of-care testing included
- EKG, spirometry, etc.
...
- Laboratory services (or note if offered at wholesale)
- Immunizations (or note how handled)
...
- Follow treatment recommendations (to extent willing)
...
- Date line
- Practice representative signature (optional but recommended)
- Witness line (if required by state)
...
After creating your agreement:
- [Payment Processing Options](payment-processing-options.md) - Collecting membership fees
- [Patient Onboarding Workflow](../operations/patient-onboarding-workflow.md) - Using the agreement in enrollment
- [HIPAA Compliance Basics](../compliance-legal/hipaa-compliance-basics.md) - Privacy practices referenced in agreement
