...
- Seth Godin's altMBA (paid but transformative)

**Finance:**
- Wave (accounting software + free education)
- Bench resources
...
1. **Rework** (shortest, most immediately actionable)
2. **The $100 Startup** (service business specific)
3. **Company of One** (philosophy for DPC)

### For Financial Discipline

1. **Profit First** (cash management)
2. **The Personal MBA** (business fundamentals)

### For Long-Term Thinking

1. **The E-Myth Revisited** (systems thinking)
