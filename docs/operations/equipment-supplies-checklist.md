...
Most situations have solutions:
- Send patient to lab/imaging
- Borrow from nearby practice (networking!)
- Refer out temporarily
- Order the equipment when pattern emerges
...
**Exam Supplies:**
- Exam table paper
- Gowns (paper or cloth)
- Gloves (multiple sizes, nitrile and latex)
- Tongue depressors
- Cotton balls/swabs
- Alcohol prep pads
- Hand sanitizer
- Tissues
- Otoscope specula (disposable)
...
- Sharps containers
- Specimen cups
- Blood tubes (if drawing labs)
- Butterfly needles
- Tourniquets
- Suture material (basic set)
- Steri-strips
- Skin prep
...
- Business cards
- Pens
- Prescription pads (if not e-prescribing)
...
- Costco/Sam's Club (gloves, sanitizer)
...
**Buy New:**
- Items where accuracy is critical (BP cuff, scales)
- Items with warranties needed
- Consumables/disposables
- Technology that changes rapidly

**Consider Used:**
- Exam tables (very durable)
- Furniture
- Non-critical equipment
- Items from retiring physicians

**Where to Find Used:**
- Physicians retiring/closing practices
...
- Typically for expensive items (EKG, spirometer)

**Recommendation:** For DPC, usually better to save and buy when ready rather than lease.

### Refurbished Equipment

Some items available refurbished with warranty:
- EKG machines
- Exam tables
...
After equipping your practice:
- [Patient Onboarding Workflow](patient-onboarding-workflow.md) - Ready to see patients
