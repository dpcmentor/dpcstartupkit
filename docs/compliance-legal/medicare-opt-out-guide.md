...
- [What is Medicare Opt-Out?](#what-is-medicare-opt-out)
- [Why DPC Physicians Opt Out](#why-dpc-physicians-opt-out)
- [Who Can Opt Out](#who-can-opt-out)
- [The Opt-Out Process](#the-opt-out-process)
- [Private Contracts](#private-contracts)
- [Maintaining Opt-Out Status](#maintaining-opt-out-status)
- [Terminating Opt-Out](#terminating-opt-out)
...
**What opt-out is NOT:**
- Simply not enrolling in Medicare
...
**Without opt-out, problems arise:**
- Medicare beneficiaries cannot pay you privately for Medicare-covered services
- Even if you don't bill, you may be obligated to bill
- Accepting cash for covered services without opt-out may violate Medicare rules

**With opt-out:**
- Medicare beneficiaries can pay DPC membership fees
- You have a clear legal framework for private-pay relationships
- No Medicare billing, claims, or audits for opted-out services

**Common DPC approach:**
Most DPC physicians who see Medicare-age patients choose to formally opt out, even if they never enrolled in Medicare in the first place, to ensure complete clarity.

---

## Who Can Opt Out

**Eligible to opt out** ([42 CFR 405.400](https://www.ecfr.gov/current/title-42/section-405.400)):
- Physicians: MD and DO, and also doctors of dental surgery or dental medicine (DDS/DMD), podiatric medicine (DPM) and optometry (OD)
...
**Cannot opt out:**
- Chiropractors, physical therapists in independent practice and occupational therapists in independent practice (Medicare Benefit Policy Manual, Ch. 15, §40.4)

**Timing** ([42 CFR 405.410](https://www.ecfr.gov/current/title-42/section-405.410)):
- Non-participating physicians and practitioners, and those who never enrolled, may opt out at any time
- Participating physicians may also opt out. The opt-out takes effect on the first day of a calendar quarter, and the affidavit must be filed at least 30 days before that day. Your participation agreement terminates on the effective date of the opt-out ([42 CFR 405.420(i)](https://www.ecfr.gov/current/title-42/section-405.420)); you do not have to wait for it to expire
- There is no rule that pending Medicare claims must be settled before you opt out. Claims for services furnished before the effective date are handled under the ordinary rules
...
- Establish whether you are participating, non-participating or never enrolled; this determines when your opt-out can take effect (see [Timing](#who-can-opt-out) above)
...
There is no CMS standard form. Most MACs publish their own affidavit form; use your MAC's. Whatever form you use, [42 CFR 405.420](https://www.ecfr.gov/current/title-42/section-405.420) requires the affidavit to:
...
- [CMS MAC List](https://www.cms.gov/medicare/coding-billing/medicare-administrative-contractors-macs/who-are-macs)
- MACs are regional; file with the MAC for your practice location

**How to file:**
- Mail or fax to your MAC
- Some MACs accept electronic submission
- Keep proof of submission (certified mail receipt, fax confirmation)

**When it takes effect** ([42 CFR 405.410(c)-(d)](https://www.ecfr.gov/current/title-42/section-405.410)):
- Non-participating or never enrolled: the opt-out is effective on the date you sign the affidavit, provided you file it with the MAC within 10 days after signing your first private contract with a Medicare beneficiary. If you file later than that, the opt-out is effective on the date the affidavit is filed
- Participating: the opt-out is effective on the first day of the calendar quarter you selected, and the affidavit must be filed at least 30 days before that day
- Do not furnish services under a private contract before the effective date

### Step 4: Prepare Private Contracts

You must have signed private contracts with Medicare beneficiaries BEFORE providing services. See [Private Contracts](#private-contracts) below.
...
[42 CFR 405.415](https://www.ecfr.gov/current/title-42/section-405.415) lists fifteen elements. Every private contract with a Medicare beneficiary must:
...
Print the contract in a legible type size, keep the signed original for the whole opt-out period, and be ready to produce it if CMS asks. The contract covers services that *would* be covered by Medicare but for the opt-out ([42 CFR 405.405(a)](https://www.ecfr.gov/current/title-42/section-405.405)); services Medicare never covers need no private contract.

### DPC Integration

For DPC practices, the private contract can be:
- Part of your membership agreement, OR
- A separate document signed at enrollment
...
- Exception for a first opt-out: you may terminate within 90 days of its effective date (see [Can I opt back in before two years?](#can-i-opt-back-in-before-two-years))

### What Happens

- You can re-enroll in Medicare
- You cannot submit claims for services provided during the opt-out period
- Your private contracts end with the opt-out period; they cannot outlive it, and each new opt-out period needs new contracts ([42 CFR 405.415(o)](https://www.ecfr.gov/current/title-42/section-405.415))

### Important

Once you terminate opt-out:
- All Medicare rules apply immediately
...
Medicare Advantage plans (Part C) are administered by private insurers, but they're still Medicare, and the opt-out rules apply to them too. An MA plan may not pay you for Medicare-covered services, with two exceptions under [42 CFR 422.220](https://www.ecfr.gov/current/title-42/section-422.220): it must pay for emergency or urgent care you furnish to its enrollees, and it may choose to pay for supplemental benefits. For routine DPC services, your MA patients pay you under the private contract.
...
- [CMS Opt-Out Affidavits dataset](https://data.cms.gov/provider-characteristics/medicare-provider-supplier-enrollment/opt-out-affidavits) — the public list of opted-out physicians and practitioners
- [CMS MAC Contact Information](https://www.cms.gov/medicare/coding-billing/medicare-administrative-contractors-macs/who-are-macs)
- [42 CFR 405.400-405.455](https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-B/part-405/subpart-D) — Medicare opt-out regulations (Subpart D)

*Sources checked against primary law and agency guidance on 2026-09-22.*

!!! note "Educational content"
...
- [Transitioning from an Existing Practice](../operations/transitioning-from-practice.md)
- [State DPC Laws Overview](state-dpc-laws-overview.md)
