...
- Basic brand identity (see [Building Your Brand](building-your-brand.md))
- Ability to explain DPC (see [Explaining DPC to Patients](explaining-dpc-to-patients.md))
...
**Minimal approach:**
- Google Business Profile (essential, not really "social media")
- One social platform (if any)
- Post occasionally, don't stress
...
**Add:**
- Consistent presence on chosen platform(s)
- Regular content (2-3 posts per week)
...
- Patient testimonials/stories (with permission)
- Video content
- Community building
...
**Pick based on:**
- Where your target patients are
...
- Explaining DPC concepts
- Myth-busting about healthcare
...
- Congratulating local businesses/people

**Behind-the-scenes:**
- Day in the life (without PHI)
- Your "why"
- Meet the practice (you, staff)

**Patient stories (with written permission):**
- Testimonials
- Success stories
- DPC impact
...
**Simple approach:**
- Monday: Health tip
- Wednesday: Practice/DPC education
- Friday: Community/personal

### Batching

Create multiple posts at once:
- Dedicate 1-2 hours weekly
- Create week's content in one sitting
- Schedule using platform tools or Hootsuite/Buffer
...
- Get written consent
- Let patient write or approve content
...
- Don't confirm someone is a patient
- General responses only
- "We appreciate feedback. Please contact us directly to discuss."
...
**Posting too much DPC pitch:**
Social media should be 80% value, 20% promotion

**Inconsistency:**
Sporadic posting is worse than not being on platform

**Buying followers:**
Fake followers provide no value; may hurt credibility

**Getting into arguments:**
Never argue on social media, especially about politics or controversial topics

**Sharing medical advice that could backfire:**
Keep advice general; direct specific questions to appointments

**Neglecting negative feedback:**
Address concerns professionally (offline when possible)
