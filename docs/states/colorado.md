...
| Category | Status |
|----------|--------|
| **DPC Legislation** | Yes — HB 17-1115 (2017) |
...
**Key provisions:**
- DPC agreements defined and exempted from insurance regulation
- Clear consumer protection requirements
...
**Website:** [dpo.colorado.gov](https://dpo.colorado.gov/)
...
**Website:** [sos.state.co.us](https://www.sos.state.co.us/)
...
|--------|---------|---------|
| Colorado Medical Board | Physician licensing | [dpo.colorado.gov](https://dpo.colorado.gov/) |
| Colorado Board of Pharmacy | Pharmacy regulations | [dpo.colorado.gov](https://dpo.colorado.gov/) |
| Colorado Secretary of State | Business registration | [sos.state.co.us](https://www.sos.state.co.us/) |

### Professional Organizations

| Organization | Website |
|--------------|---------|
| Colorado Medical Society | [cms.org](https://www.cms.org/) |

### DPC Resources

- [DPC Frontier Colorado](https://www.dpcfrontier.com/colorado-1)
