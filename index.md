...
[![DPC Mentor Platform](https://img.shields.io/badge/Companion-DPC%20Mentor%20Platform-blue.svg)](#)
...
|----------|-------------|
| :stethoscope: **Physicians considering DPC** | Learn what Direct Primary Care is all about |
| :rocket: **Physicians actively starting** | Step-by-step guidance for launching your practice |
| :repeat: **Physicians transitioning** | Moving from employed or traditional practice to DPC |
| :teacher: **DPC mentors** | Resources for guiding the next generation |
...
<div class="card" markdown>
### :busts_in_silhouette: Mentoring
Resources for DPC Mentor Platform participants — mentors and mentees.
[Explore →](mentoring/README.md)
</div>
...
- :white_check_mark: Share and adapt with attribution
- :white_check_mark: Use for educational and personal purposes
- :x: **Not for commercial use** without permission
